...
namespace Adventure_rpg
{
    public class ItemList //Инициализация всех предметов в игре
    {
        ...
        static Weapon oldSword = new Weapon("Старый меч", "Не лучшее оружие, но всё ещё может оказаться полезным.", "weapon", 3, "Воин");
        static Weapon steelSword = new Weapon("Стальной меч", "Добротно сделанный меч.","weapon", 6,"Воин");
        static Weapon silverSword = new Weapon("Серебряный меч", "На рукояти нарисовано множество замысловатых рисунков...", "weapon", 12, "Воин");
        ...
        static Armor leatherGloves = new Armor("Кожаные перчатки", "Стиляга =)", 2, "Нагрудник");
        ...
        static Armor ironGloves = new Armor("Железные перчатки", "Пальцы как деревянные... ", 3, "Нагрудник");
        ...
        static HealConsumables smallHealPotion = new HealConsumables("Малое зелье лечения", "Сразу станет лучше", "Зелье", 5, 10);
        static HealConsumables mediumHealPotion = new HealConsumables("Среднее зелье лечения", "Сразу станет лучше", "Зелье", 5, 10);
        static HealConsumables largeHealPotion = new HealConsumables("Большое зелье лечения", "Сразу станет лучше", "Зелье", 5, 10);
